...
dir_assets = 'assets'
icon = os.path.join(dir_assets, 'icon.png')
...
class Avatar:
    ...
    def desenhar(self, tela):
        ...
        pygame.draw.arc(tela, PRETO, (self.x - 10, self.y - 5, 20, 15), math.radians(200), math.radians(340), 2)

class PontoJogo:
    def __init__(self, x, y, nome, funcao, icone_path, cor_fundo=(200,200,200)):
        self.x = x
        self.y = y
        self.nome = nome
        self.funcao = funcao
        self.raio = 35
        self.icone = pygame.image.load(icone_path).convert_alpha()
    ...
    def desenhar(self, tela, selecionado=False):
        if selecionado:
            ...
            scale = (math.sin(pygame.time.get_ticks() * 0.005) + 1) / 10 + 1
...
def draw_centered_title(tela, text):
    shadow = fonte_grande.render(text, True, PRETO)
    txt = fonte_grande.render(text, True, BRANCO)
    rect = txt.get_rect(center=(LARGURA // 2, 30))
    tela.blit(shadow, (rect.x + 1, rect.y + 1))
    tela.blit(txt, rect)
...
def main():
    ...
    pontos = [
        PontoJogo(150, 500, "Adivinhação", jogar_adivinhacao, os.path.join(dir_assets, "alvo.png"), (255, 100, 100)),
        PontoJogo(300, 400, "Forca", jogo_da_forca, os.path.join(dir_assets, "forca.png"), (255, 165, 0)),
        PontoJogo(500, 300, "Labirinto", jogar_labirinto, os.path.join(dir_assets, "labirinto.png"), (30, 160, 70)),
        PontoJogo(700, 200, "Pac-Man", jogar_pacman, os.path.join(dir_assets, "pacman.png"), (255, 255, 100)),
        PontoJogo(850, 300, "Snake", snake, os.path.join(dir_assets, "snake.png"), (140, 70, 190)),
        PontoJogo(750, 450, "Space Shooter", space_shooter, os.path.join(dir_assets, "foguete.png"), (100, 180, 230)),
        PontoJogo(900, 550, "Sair", None, os.path.join(dir_assets, "sair.png"), (220, 50, 50)),
    ]
